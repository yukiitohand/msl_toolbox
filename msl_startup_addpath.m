function [] = msl_startup_addpath(error_if_not_unique,silent_if_not_unique)
% msl_startup_addpath
...
%  USAGE
%  >> msl_startup_addpath()
%  >> msl_startup_addpath(error_if_not_unique)
%  >> msl_startup_addpath(error_if_not_unique,silent_if_not_unique)
%  
