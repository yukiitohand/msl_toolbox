function [ data,colinfo2,colinfo_names ] = mslplc_view_csv_read(fpath,lbl_mslplc_view)
% [ data,colinfo2,colinfo_names ] = mslplc_view_csv_read(fpath,lbl_mslplc_view)
%   Read MSL PLACES view CSV files.
%    Input Parameters
%    fpath: file path to the MSL PLACES view csv file '*.csv'
...
obj_csv = lbl_mslplc_view.OBJECT_SPREADSHEET;
