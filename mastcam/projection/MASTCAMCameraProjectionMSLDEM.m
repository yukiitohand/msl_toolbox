    ...
    methods
        ...
        function loadCache_projmastcam2MSLDEM(obj,varargin)
            ...
            if exist(cachepath,'file')
                 [obj.mastcam_NEE,~,obj.mastcam_range,...
                     ~,~,...
        ...
        function loadCache_UFOVmask(obj,varargin)
            ...
            if exist(fpath_ufovc,'file')
                [obj.msldemc_imUFOVmask,obj.msldemc_imUFOVhdr,...
                 ...
                 obj.mapper_mastcam2msldemc,obj.mapper_msldemc2mastcam_mat,obj.mapper_msldemc2mastcam_cell]...
                 = mastcam_crop_msldemc_imUFOVmask(obj,varargin{:},'Cache_Ver',obj.version);
            else
                error('No cache file exist');
            end
        end
