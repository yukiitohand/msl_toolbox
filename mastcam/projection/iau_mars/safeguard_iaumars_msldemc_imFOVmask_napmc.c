/* =====================================================================
 * safeguard_iaumars_msldemc_imFOVmask_napmc.c
 ...
 * 4 msldemc_lonigude      Double array [S_demc]
 * 5 mslrad_offset         Double Scalar
 * 6 msldem_imFOVmaskd     int8 [L_demc x S_demc]
 * 7 cmmdl                 CAHV model class
 * 
 * 
 * OUTPUTS:
...
void safeguard_imFOVmask(char *msldem_imgpath, EnviHeader msldem_hdr, 
        ...
        double mslrad_offset, int8_T **msldemc_imFOVmaskd, 
