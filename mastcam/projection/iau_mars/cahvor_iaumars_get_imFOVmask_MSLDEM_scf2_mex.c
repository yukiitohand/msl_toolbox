/* =====================================================================
 * cahvor_iaumars_get_imFOVmask_MSLDEM_scf2_mex.c
 ...
 * 11 re                  Double Scalar equatorial radius
 * 12 rp                  Double Scalar polar radius
 * 
 * OUTPUTS:
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    re = mxGetScalar(prhs[11]);
    rp = mxGetScalar(prhs[12]);
