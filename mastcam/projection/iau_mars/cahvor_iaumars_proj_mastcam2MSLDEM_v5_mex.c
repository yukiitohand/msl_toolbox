            ...
            if(msldemc_imFOVmask[c][l]>0 || msldemc_imFOVmask[c][l+1]>0){
                ...
                for(sxy=0;sxy<2;sxy++){
                    if(sxy==0){
                        ...
                        radius_tmp = (double) elevl[c+1] + mslrad_offset;
                        ppv1gx = radius_tmp * cos_latl * cos_lon[c+1];
                        ppv1gy = radius_tmp * cos_latl * sin_lon[c+1];
                        ppv1gz = radius_tmp * sin_latl;
                        radius_tmp = (double) elevlp1[c+1] + mslrad_offset;
                        ppv2gx = radius_tmp * cos_latlp1 * cos_lon[c+1];
                        ppv2gy = radius_tmp * cos_latlp1 * sin_lon[c+1];
