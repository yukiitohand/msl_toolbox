/* =====================================================================
 * lib_proj_mastcamMSLDEM_IAUMars_L2SMP_DAR_M3.h 
 ...
 * mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_DAR_M3
 * DYM : DYnamic Masking of the points already labelled as invisible.
 *
 * ===================================================================== */


#ifndef LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_DAR_M3_H
#define LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_DAR_M3_H
...
/* with dynamic array masking */
void mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_DARDYM_M3(
        ...
        int64_T count_papmc, int32_T *c_papmc, int32_T *l_papmc, double *rad_papmc,
...
//                         ppv3gz = ((double) -elevlp1[c]) - cam_C[2];
                    ...
                    if(isinFOVd){
                        ...
                        */
                        ...
                        for (n=0;n<count_papmc;n++){
                            cc = c_papmc[n];
                            ll = l_papmc[n];
                            /* evaluate line param */
                            if(msldemt_inImage[cc][ll]){
                                radius_tmp = rad_papmc[n];
