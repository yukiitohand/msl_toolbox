/* =====================================================================
 * iaumars_get_msldemtUFOVmask_ctr_L2SMP_LL0_M3_mex.c
...
#include "cahvor.h"
#include "lib_proj_mastcamMSLDEM_IAUMars_L2SMP_LL0_M3.h"

void create_SMPLL0_msldemt_ctr_iaumars(double S_im, double L_im, CAHV_MODEL cahv_mdl,
        ...
        for(c=0;c<msldemc_samples;c++){
            if(msldemc_imFOVmask[c][l]>1){
                ...
                if(ll_papmc_next!=NULL){
                     ...
                     */
                    (*ll_papmc) = malloc(sizeof(struct MSLDEMmask_LinkedList));
                    ll_papmc_next = (*ll_papmc);
                    ll_papmc_next->c = c;
                    ll_papmc_next->l = l;
                    ll_papmc_next->radius = radius_tmp;
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    /* -----------------------------------------------------------------
     * Pre-processing to create simple linked list 
     * ----------------------------------------------------------------- */
    ll_papmc = NULL;
    ll_napmc = NULL;
    ll_tmp   = NULL;
    strt_time = clock();
    create_SMPLL0_msldemt_ctr_iaumars(S_im, L_im, cahv_mdl,
