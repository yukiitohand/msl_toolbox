/* =====================================================================
 * lib_proj_mastcamMSLDEM_IAUMars_L2SMP_LLP_M3_SCIMXY.h 
...
#ifndef LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_LLP_M3_SCIMXY_H
#define LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_LLP_M3_SCIMXY_H
...
void mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LLPDYU_M3_SCIMXY(
...
void mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LLP_M3_SCIMXY(
        char *msldem_imgpath, EnviHeader msldem_header, double mslrad_offset,
        int32_T msldemc_imxy_sample_offset, int32_T msldemc_imxy_line_offset,
        int32_T msldemc_samples, int32_T msldemc_lines,
        double *msldemc_latitude, double *msldemc_longitude, int8_T **msldemc_imFOVmask,
