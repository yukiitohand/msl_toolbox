/* =====================================================================
 * lib_proj_mastcamMSLDEM_IAUMars_L2SMP_LL0_M3.h 
 ...
 * mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LL0DYU_M3
 * mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LL0_M3
 *
...
#ifndef LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_LL0_M3_H
#define LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_LL0_M3_H
...
void mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LL0DYU_M3(
        ...
        double S_im, double L_im, CAHV_MODEL cahv_mdl)
{
    ...
    struct MSLDEMmask_LinkedList *ll_papmc0;
    struct MSLDEMmask_LinkedList *ll_napmc0;
...
void mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LL0_M3(
        char *msldem_imgpath, EnviHeader msldem_header, double mslrad_offset,
        int32_T msldemc_imxy_sample_offset, int32_T msldemc_imxy_line_offset,
        int32_T msldemc_samples, int32_T msldemc_lines,
        double *msldemc_latitude, double *msldemc_longitude, int8_T **msldemc_imFOVmask,
