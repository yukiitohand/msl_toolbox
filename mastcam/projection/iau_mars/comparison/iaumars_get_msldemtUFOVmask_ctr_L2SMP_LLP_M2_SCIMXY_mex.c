/* =====================================================================
 * iaumars_get_msldemtUFOVmask_ctr_L2SMP_LLP_M2_SCIMXY_mex.c
...
#include "cahvor.h"
#include "lib_proj_mastcamMSLDEM_IAUMars_L2SMP_LLP_M2_SCIMXY.h"
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    /* -----------------------------------------------------------------
     * pre-processing. create a simple linked list with projected coordinate
     * ----------------------------------------------------------------- */
    ll_papmc = NULL;
    ll_napmc = NULL;
    ll_tmp   = NULL;
    ...
    if(dyu==1){
        ...
        printf("Not implemented yet for DYU_FLAG=%d\n",dyu);
    } else {
