/* =====================================================================
 * lib_proj_mastcamMSLDEM_IAUMars_L2SMP_LLP_M2_SCIMXY.h 
 ...
 * mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LLPDYU_M2_SCIMXY
 * below is not implmented yet.
 * mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LLP_M2_SCIMXY
 * 
 * DYU : DYnamic Update of Linked List by removing invisible points at the time it is labelled.
 * 
 *
 * ===================================================================== */
#ifndef LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_LLP_M2_SCIMXY_H
#define LIB_PROJ_MASTCAMMSLDEM_IAUMARS_L2SMP_LLP_M2_SCIMXY_H
...
void mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LLPDYU_M2_SCIMXY(
                        ...
                        */
                        ...
                        while(ll_papmc_next!=NULL){
                            ...
                            if(imx>x_min && imx<x_max && imy>y_min && imy<y_max){
                                pipvx = imx - ppv1x; pipvy = imy - ppv1y; 
