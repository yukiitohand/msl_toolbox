/* =====================================================================
 * iaumars_get_msldemtUFOVmask_ctr_L2SMP_LLP_M3_SCIMXY_STAA_mex.c
 * 
...
#include "cahvor.h"
#include "lib_proj_mastcamMSLDEM_IAUMars_L2SMP_LLP_M3_SCIMXY_STAA.h"
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    if(dyu==1){
        ...
        mask_obstructed_pts_in_msldemt_using_msldemc_iaumars_L2SMP_LLP_M3_SCIMXY_STAA(
                msldem_imgpath, msldem_header, mslrad_offset,
            (int32_T) msldemc_imxy_sample_offset, (int32_T) msldemc_imxy_line_offset,
            (int32_T) msldemc_samples, (int32_T) msldemc_lines,
            msldemc_latitude, msldemc_longitude, msldemc_imFOVmask,
