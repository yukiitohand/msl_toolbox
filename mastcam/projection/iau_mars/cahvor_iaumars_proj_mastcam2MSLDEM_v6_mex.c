/* =====================================================================
 * cahvor_iaumars_proj_mastcam2MSLDEM_v6_mex.c
 ...
 * 3 msldemc_latitude      Double array [L_demc]
 * 4 msldemc_longitude     Double array [S_demc]
 * 5 mslrad_offset         Double Scalar
...
//                         pmc1x = ppv1gx-cam_C[0]; pmc1y = ppv1gy-cam_C[1]; pmc1z = ppv1gz-cam_C[2];
//                         dv1 = pmc1x*cam_A[0] + pmcy*cam_A[1] + pmcz*cam_A[2];
//                         ppv1x = (pmc1x*cam_H[0] + pmcy*cam_H[1] + pmcz*cam_H[2])/dv1;
//                         ppv1y = (pmc1x*cam_V[0] + pmcy*cam_V[1] + pmcz*cam_V[2])/dv1;
//                         
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    PmCy = set_mxDoubleMatrix(prhs[11]);
    PmCz = set_mxDoubleMatrix(prhs[12]);
