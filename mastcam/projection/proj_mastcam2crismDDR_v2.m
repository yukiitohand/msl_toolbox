function [mastcam_prj,DDRprj] = proj_mastcam2crismDDR_v2(mastcamdata_obj,DDRprj,varargin)
% [mastcam_prj,DDRprj] = proj_mastcam2crismDDR_v2(mastcamdata_obj,DDRprj,varargin)
    ...
    for s = valid_samples
        ...
        for j=1:2
            ...
            if ~ppv_xy_isnan % && cnd_xy < cnd_geo*10 && 
                ...
                [plane_param_im,is_in_face] = get_plane_param_coefficient(...
                    ppv1,ppv2,ppv3,im_imxy_vec2d(:,idx_xy2d_list),precision,is_gpu,proc_page);
