 ...
 * 
 * OUTPUTS:
 * 0  msldemcedge_inImage     int8_T [L_demc x (S_demc-1)]
 * 
 *
 *
                            ...
                            for(yi=y_min_int;yi<y_max_int;yi++){
                                for (n=0;n<bin_count_im[xi][yi];n++){
                                    ...
                                    if(msldemc_imxm[cc][ll] > x_min && msldemc_imxm[cc][ll] < x_max && msldemc_imym[cc][ll] > y_min && msldemc_imym[cc][ll] < y_max)
                                    {
                                        ...
                                        lprm = lprm_nume/(pnx*msldemc_northing[ll]+pny*msldemcm_easting[cc]+pnz*0.5*(msldemc_img[cc][ll]+msldemc_img[cc+1][ll]));
                                        if(lprm<1 && lprm>0){
                                            ...
                                            if(pprm_sd>0 && pprm_td>0 && pprm_1std>0){
                                                if(((cc==c) && (ll==l) && (ti==0)) || ((cc==c) && (ll==l-1) && (ti==1)) ){
                                                } else {
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    plhs[0] = mxCreateNumericMatrix(L_demc,S_demcm1,mxINT8_CLASS,mxREAL);
