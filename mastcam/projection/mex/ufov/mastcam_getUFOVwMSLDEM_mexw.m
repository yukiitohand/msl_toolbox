            ...
            switch upper(PROC_MODE)
                ...
                case 'L2PBK_DAR_M3'
                    tic; [ msldemc_imUFOVmask_ctr] =  ...
                        ...
                        MSTproj.msldemc_imFOVhdr,...
                        msldemc_latitude,msldemc_longitude, ...
                        MSTproj.msldemc_imFOVmask,S_im,L_im,cmmdl_geo,K_L,K_S,0); toc;
                case 'L2PBK_DARDYM_M3'
                    tic; [ msldemc_imUFOVmask_ctr] =  ...
                        ...
                        MSTproj.msldemc_imFOVhdr,...
                        msldemc_latitude,msldemc_longitude, ...
                        MSTproj.msldemc_imFOVmask,S_im,L_im,cmmdl_geo,K_L,K_S,1); toc;
                case 'L2PBK_LL0_M3'
                    tic; [ msldemc_imUFOVmask_ctr] =  ...
                ...
                case 'L2SMP_DAR_M3'
                    tic; [ msldemc_imUFOVmask_ctr] =  ...
                        ...
                        MSTproj.msldemc_imFOVhdr,...
                        msldemc_latitude,msldemc_longitude, ...
                        MSTproj.msldemc_imFOVmask,S_im,L_im,cmmdl_geo,0); toc;
                case 'L2SMP_DARDYM_M3'
                    tic; [ msldemc_imUFOVmask_ctr] =  ...
                        ...
                        MSTproj.msldemc_imFOVhdr,...
                        msldemc_latitude,msldemc_longitude, ...
                        MSTproj.msldemc_imFOVmask,S_im,L_im,cmmdl_geo,1); toc;
                case 'L2SMP_LL0_M3'
                    tic; [ msldemc_imUFOVmask_ctr] =  ...
...
%             if K_L>1 || K_S>1
%                 tic; [ msldemc_imUFOVmask_ctr] = iaumars_get_msldemtUFOVmask_ctr_wmsldemc_L2_3x3me_simple_llqmex(...
%                     MSLDEMdata.imgpath,MSLDEMdata.hdr, MSLDEMdata.OFFSET, ...
%                     MSTproj.msldemc_imFOVhdr,...
%                     msldemc_latitude,msldemc_longitude, ...
%                     MSTproj.msldemc_imFOVmask,S_im,L_im,cmmdl_geo); toc;
% %                 tic; [ msldemc_imUFOVmask_ctr] = iaumars_get_msldemtUFOVmask_ctr_wmsldemc_L2K_3x3me_mex(...
% %                     MSLDEMdata.imgpath,MSLDEMdata.hdr, MSLDEMdata.OFFSET, ...
% %                     MSTproj.msldemc_imFOVhdr,...
% %                     msldemc_latitude,msldemc_longitude, ...
% %                     MSTproj.msldemc_imFOVmask,S_im,L_im,cmmdl_geo,K_L,K_S); toc;
