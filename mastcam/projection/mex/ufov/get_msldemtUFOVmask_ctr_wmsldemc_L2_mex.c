/* =====================================================================
 * get_msldemtUFOVmask_ctr_wmsldemc_L2_mex.c
...
void bin_msldemt_xyz_wAHVint_L2_ctr(int32_T S_im, int32_T L_im, CAHV_MODEL cahv_mdl,
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    bin_msldemt_xyz_wAHVint_L2_ctr((int32_T) S_im, (int32_T) L_im, cahv_mdl,
    ...
    mask_obstructed_pts_in_msldemt_using_msldemc_L2(msldem_imgpath, msldem_header, 
        ...
        msldemc_xmc, msldemc_ymc, msldemt_imUFOVmask,
