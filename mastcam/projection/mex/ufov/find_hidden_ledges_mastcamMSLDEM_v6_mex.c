/* =====================================================================
 * find_hidden_ledges_mastcamMSLDEM_v6_mex.c
 ...
 * 
 * OUTPUTS:
 * 0  msldemc_inImage     [(L_demc-1) x S_demc]  Boolean
 * 
 *
 *
                            ...
                            for(yi=y_min_int;yi<y_max_int;yi++){
                                for (n=0;n<bin_count_im[xi][yi];n++){
                                    ...
                                    if(msldemc_imxm[cc][ll] > x_min && msldemc_imxm[cc][ll] < x_max && msldemc_imym[cc][ll] > y_min && msldemc_imym[cc][ll] < y_max)
                                    {
                                        ...
                                        lprm = lprm_nume/(pnx*msldemcm_northing[ll]+pny*msldemc_easting[cc]+pnz*0.5*(msldemc_img[cc][ll]+msldemc_img[cc][ll+1]));
                                        if(lprm<1 && lprm>0){
                                            ...
                                            if(pprm_sd>0 && pprm_td>0 && pprm_1std>0){
                                                if( ((cc==c) && (ll==l) && (ti==0)) || ((cc==c-1) && (ll==l) && (ti==1)) ){
                                                } else {
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    plhs[0] = mxCreateNumericMatrix(L_demcm1,S_demc,mxINT8_CLASS,mxREAL);
