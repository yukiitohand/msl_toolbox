/* =====================================================================
 * get_imxyclm_MSLDEM_mex.c
 * GET coordinate values in the image coordinate of vertices of each pixel 
 * in the DEM image.
 * 
 * INPUTS:
        ...
        double **msldemc_imxm, double **msldemc_imym)
{
    ...
    for(l=0;l<msldemc_linesm1;l++){
        ...
        vpmcx = cam_V[0] * pmcx;
        for(c=0;c<msldemc_samplesm1;c++){
            if(((msldemc_imFOVmaskd[c][l]==2) && (msldemc_imFOVmaskd[c+1][l]==2)) || ((msldemc_imFOVmaskd[c][l+1]==2) && (msldemc_imFOVmaskd[c+1][l+1]==2))){
                dem_cl = 0.5*((double) (elevl[c+1] + elevlp1[c]));
                pmcz  = -dem_cl-cam_C[2];
                apmcz = cam_A[2] * pmcz;
                hpmcz = cam_H[2] * pmcz;
                vpmcz = cam_V[2] * pmcz;
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    plhs[1] = mxCreateDoubleMatrix(msldemc_linesm1,msldemc_samplesm1,mxREAL);
