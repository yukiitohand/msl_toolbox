...
void bin_msldemt_xyz_wAHVint_L(int32_T S_im, int32_T L_im,
...
void mask_obstructed_pts_in_msldemt_using_msldemc_L(char *msldem_imgpath, EnviHeader msldem_header, 
        ...
        )
{
    ...
    bin_msldemt_xyz_wAHVint_L(S_im, L_im, cam_A, cam_H, cam_V,
