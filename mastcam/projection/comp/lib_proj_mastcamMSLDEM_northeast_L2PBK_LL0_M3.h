/* =====================================================================
 * lib_proj_mastcamMSLDEM_northeast_L2PBK_LL0_M3.h 
...
#ifndef LIB_PROJ_MASTCAMMSLDEM_NORTHEAST_L2PBK_LL0_M3_H
#define LIB_PROJ_MASTCAMMSLDEM_NORTHEAST_L2PBK_LL0_M3_H
...
void mask_obstructed_pts_in_msldemt_using_msldemc_ne_L2PBK_LL0DYU_M3(
        char *msldem_imgpath, EnviHeader msldem_header,
        int32_T msldemc_imxy_sample_offset, int32_T msldemc_imxy_line_offset,
        int32_T msldemc_samples, int32_T msldemc_lines,
        double *msldemc_northing, double *msldemc_easting, int8_T **msldemc_imFOVmask,
        int32_T msldemt_samples, int32_T msldemt_lines,
        double *msldemt_northing, double *msldemt_easting, int8_T **msldemt_inImage,
        ...
        double S_im, double L_im, CAHV_MODEL cahv_mdl)
{
    ...
    if(msldemt_northing==NULL){
        msldemt_northing = msldemc_northing;
    }
    if(msldemt_easting==NULL){
        msldemt_easting = msldemc_easting;
    } else {
    }
                        ...
                        for(xi=x_min_int;xi<x_max_int;xi++){
                            for(yi=y_min_int;yi<y_max_int;yi++){
                                ...
                                while(ll_curr){
                                    ...
                                    ll = ll_curr->l;
                                    /* evaluate line param */
                                    x_cl  = msldemt_northing[ll];
                                    y_cl  = msldemt_easting[cc];
                                    z_cl  = ll_curr->z;
                                    pmcx = x_cl - cam_C[0];
                                    pmcy = y_cl - cam_C[1];
                                    pmcz = z_cl - cam_C[2];
