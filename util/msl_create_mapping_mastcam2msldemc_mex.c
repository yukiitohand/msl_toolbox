/* =====================================================================
 * msl_create_mapping_mastcam2msldemc_mex.c
    ...
    for(mwsi=0;mwsi<mwS_dem;mwsi++){
        for(mwli=0;mwli<mwL_dem;mwli++){
            if(msldemc_imUFOVnnx[mwsi][mwli]>-1){
                mapper_countar[msldemc_imUFOVnnx[mwsi][mwli]][msldemc_imUFOVnny[mwsi][mwli]]++;
            }
        }
    }
    // printf("%d\n",S_im);
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    // int32_T **mastcam_msldemc_nnx_imUFOV, **mastcam_msldemc_nny_imUFOV;
    mwSize L_dem,S_dem;
    mwSize L_im,S_im;
    ...
    */
    ...
    L_im   = (mwSize) mxGetScalar(prhs[2]);
